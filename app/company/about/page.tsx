        ...
        <div className="space-y-8">
          ...
          <div className="bg-blue-900 p-8 rounded-2xl shadow-md text-white">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/dashboard.php?id=61569757534336" target="_blank" rel="noopener noreferrer" className="bg-white/10 p-3 rounded-lg hover:bg-white/20 hover:scale-105 transition-all flex items-center justify-center" aria-label="Facebook">
