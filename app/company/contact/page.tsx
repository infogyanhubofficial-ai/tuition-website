          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
              ...
              <div className="flex flex-wrap gap-4">
                {/* Facebook */}
                <a href="https://www.facebook.com/dashboard.php?id=61569757534336" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-slate-100 text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all duration-300">
