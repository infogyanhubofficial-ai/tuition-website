...
function TutorCard({ tutor, onQuickView }: { tutor: Tutor; onQuickView: (t: Tutor) => void }) {
  ...
  // Determine thicker border logic based on requirements (border-2 applied here)
    ...
    >
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="min-w-0 flex-1 pt-1">
            <div className="flex items-center gap-2">
              ...
              {/* Profile Completeness / Verified Indicator - Now Blue */}
              {tutor.verified && (
      ...
      <div className="mt-6 flex flex-col gap-4 border-t border-slate-100/80 pt-5">
        ...
        <div className="flex gap-2 w-full">
          <button 
            onClick={(e) => { 
              e.stopPropagation(); // Stop clicking card background
              e.preventDefault(); 
              onQuickView(tutor); 
            }}
          ...
          <Link 
            ...
            onClick={(e) => e.stopPropagation()} // Stop clicking card background
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-4xl font-black tracking-tight text-slate-900 sm:text-5xl">
              Find Expert <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Tutors</span>
            </h1>
            <p className="mt-2 text-slate-500 font-medium">Connect with the best educators in Nepal.</p>
          </div>
            ...
            isMobileFilterOpen ? "block" : "hidden"
             ...
             <div className="sticky top-28 rounded-3xl border border-white/60 bg-white/70 p-6 shadow-xl shadow-slate-200/40 backdrop-blur-md space-y-7">
                ...
                <div className="space-y-6">
                  <div>
                    <label className="text-[11px] font-black uppercase tracking-widest text-slate-500 mb-3 block">Search Subject</label>
                  ...
                  <div>
                    <label className="text-[11px] font-black uppercase tracking-widest text-slate-500 mb-3 block">Location</label>
                    <select 
                  ...
                  <div className="group relative">
                    <div className="flex justify-between items-end mb-4">
                      <label className="text-[11px] font-black uppercase tracking-widest text-slate-500 block">Max Hourly Rate</label>
              ...
              <div className="flex flex-col h-full">
                <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
                  <AnimatePresence mode="popLayout">
                    {paginatedTutors.length > 0 ? (
                      ...
                      >
                        {/* Custom Illustrated Empty State Concept */}
                ...
                {totalPages > 1 && (
                  <div className="mt-12 flex items-center justify-between border-t border-slate-200/60 pt-6 mb-8">
                    ...
                    <span className="text-sm font-semibold text-slate-500 bg-white/50 px-4 py-2 rounded-lg backdrop-blur-sm">
      ...
      <AnimatePresence>
        {quickViewTutor && (
          ...
          >
            ...
            >
              <button onClick={() => setQuickViewTutor(null)} className="absolute right-6 top-6 rounded-full p-2 text-slate-400 hover:bg-slate-100 hover:text-slate-700 transition-colors">
                <X className="h-5 w-5" />
              </button>
              <div className="flex items-center gap-5 mb-6">
                <img src={quickViewTutor.avatar_url || quickViewTutor.photo || ''} alt="" className="h-20 w-20 rounded-3xl object-cover bg-slate-100 shadow-sm border border-slate-100" />
                <div>
                  <div className="flex items-center gap-2">
              ...
              <Link href={`/tutors/${quickViewTutor.id}`} className="flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 py-4 text-sm font-bold text-white shadow-lg shadow-blue-500/25 transition-all hover:shadow-xl hover:-translate-y-0.5 active:scale-95">
                View Full Profile
              </Link>
            </motion.div>
          </motion.div>
