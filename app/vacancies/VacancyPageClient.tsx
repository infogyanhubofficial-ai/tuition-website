...
// [SEO FIX] Helper function to generate SEO-friendly URLs for Vacancies
...
function GridIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" className={cn("h-4 w-4 transition-colors", active ? "text-orange-600" : "text-slate-400")} fill="none" aria-hidden="true">
  ...
  return (
    <div className="mt-12 sticky bottom-6 flex justify-center z-30 pointer-events-none">
      <div className="inline-flex items-center gap-2 rounded-full border border-slate-200/60 bg-white/80 px-2 py-2 shadow-[0_8px_30px_rgb(0,0,0,0.08)] backdrop-blur-xl pointer-events-auto">
        ...
        <span className="text-sm font-semibold text-slate-500 px-3" aria-label={`Page ${currentPage} of ${totalPages}`}>
          ...
          <aside className="relative hidden lg:block">
            <div className="sticky top-28 rounded-[32px] border border-white/40 bg-white/60 p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl">
              ...
              <div className="space-y-6">
                <div>
                  <label htmlFor="search-input" className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2 block">Search Keyword</label>
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      aria-label="Search vacancies by subject or location"
                ...
                <div>
                  <label htmlFor="mode-select" className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2 block">Teaching Mode</label>
                ...
                <button 
                  ...
                  aria-label="Toggle urgent vacancies only"
                  className={cn(
                ...
                <div className="mt-8 rounded-[24px] bg-gradient-to-br from-slate-900 to-slate-800 p-6 text-white text-center shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] relative overflow-hidden border border-slate-700/50">
                   ...
                   <div className="relative z-10">
                     ...
                     <a 
                       ...
                       aria-label="Set up WhatsApp alerts for new vacancies"
              ...
              <div className={cn(
                ...
                {paginatedVacancies.map((vacancy) => {
                  ...
                  return (
                    <article
                      key={vacancy.id}
                      // [SEO FIX] Changed direct ID to SEO-friendly slug
                      onClick={() => router.push(`/vacancies/${generateVacancySeoSlug(vacancy)}`)}
                      className={cn(
                    ...
                    >
                      ...
                      <div className={cn(
                        ...
                        >
                          <Link 
                            // [SEO FIX] Changed to SEO-friendly slug
                            href={`/vacancies/${generateVacancySeoSlug(vacancy)}/apply`}
                            aria-label={`Apply for ${vacancy.subject} vacancy`}
